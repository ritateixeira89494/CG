...
vector<vector<float>> p_vector = {
        {get<0>(P0),  get<1>(P0),  get<2>(P0),
                get<0>(P1),  get<1>(P1),  get<2>(P1),
                get<0>(P2),  get<1>(P2),  get<2>(P2),
                get<0>(P3),  get<1>(P3),  get<2>(P3)},

        {get<0>(P4),  get<1>(P4),  get<2>(P4),
                get<0>(P5),  get<1>(P5),  get<2>(P5),
                get<0>(P6),  get<1>(P6),  get<2>(P6),
                get<0>(P7),  get<1>(P7),  get<2>(P7)},

        {get<0>(P8),  get<1>(P8),  get<2>(P8),
                get<0>(P9),  get<1>(P9),  get<2>(P9),
                get<0>(P10), get<1>(P10), get<2>(P10),
                get<0>(P11), get<1>(P11), get<2>(P11)},

        {get<0>(P12), get<1>(P12), get<2>(P12),
                get<0>(P13), get<1>(P13), get<2>(P13),
                get<0>(P14), get<1>(P14), get<2>(P14),
                get<0>(P15), get<1>(P15), get<2>(P15)}
};

Matrix points = Matrix(p_vector);
...
std::tuple<float, float, float> BezierSurface::P(Matrix *control_points, float u, float v) {
    ...
    Matrix v_vector = Matrix({
                                     {powf(v, 3), powf(v, 2), v, 1}
                             });
    Matrix temp1 = u_vector * M * points * M.transpose() * v_vector;
